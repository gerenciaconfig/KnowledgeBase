...
namespace Letra
{
	public class AlphabetGameManager : MonoBehaviour
	{
		...
		/// </summary>
		public static AlphabetGameManager instance;
		...
		public void Spell()
		{
			if (ShapesManager.instance.GetCurrentShape().clip == null)
			{
				return;
			}

			AudioSources.instance.audioSources[1].Stop();
			AudioSources.instance.audioSources[1].clip = ShapesManager.instance.GetCurrentShape().clip;
